...
class CircuitBreaker:
    ...
    def _record_failure(self):
        ...
        self.last_failure = lib.time_functions.get_timestamp()
...
class CollectionEntry(pydantic.BaseModel):
    ...
    score: float
    original_format: str
    links: list[dict[str, str]] = pydantic.Field(default_factory=list[dict[str, str]])


class FeedItem(pydantic.BaseModel):
...
class CMRSearchParameters(pydantic.BaseModel):
    entry_title: str | None = pydantic.Field(default=None)
    entry_id: str | None = pydantic.Field(default=None)
    data_center: str | None = pydantic.Field(default=None)
    project: str | None = pydantic.Field(default=None)
    consortium: str | None = pydantic.Field(default=None)
    platform: str | None = pydantic.Field(default=None)
    instrument: str | None = pydantic.Field(default=None)
    sensor: str | None = pydantic.Field(default=None)
    browsable: str | None = pydantic.Field(default=None)
    keyword: str | None = pydantic.Field(default=None)
    provider: str | None = pydantic.Field(default=None)
    short_name: str | None = pydantic.Field(default=None)
    tag_parameters: str | None = pydantic.Field(default=None)
    service_parameters: str | None = pydantic.Field(default=None)
    author: str | None = pydantic.Field(default=None)
    standard_product: str | None = pydantic.Field(default=None)


# TODO: Maybe put the types of the arguments here to help the API supply the correct arguments
class CMRQueryParameters(pydantic.BaseModel):
    """
...
class CMRAutocompleteEndpointParameters(pydantic.BaseModel):
    query: str
...
async def query_cmr_autocomplete_endpoint(query: str) -> list[AutocompleteEntry] | None:
    ...
    """
    cleaned_query: str = lib.string_functions.replace_double_newline(query)
    response = await lib.http_functions.get_request(
        f"{Configuration.base_endpoint}{src.ENUMS.CMR_ENDPOINTS.AUTOCOMPLETE.value}.json",
...
async def query_cmr_collections_endpoint(keyword: str):
    ...
    Returns:
      A list of possible datasets that might include information about the search term
    """
    cleaned_keyword: str = lib.string_functions.replace_double_newline(keyword)
    response = await lib.http_functions.get_request(
        url=f"{Configuration.base_endpoint}{src.ENUMS.CMR_ENDPOINTS.COLLECTIONS.value}.json",
...
async def query_cmr_granules_endpoint(keyword: str):
    ...
    cleaned_keyword: str = lib.string_functions.replace_double_newline(keyword)
    response = await lib.http_functions.get_request(
        url=f"{Configuration.base_endpoint}{src.ENUMS.CMR_ENDPOINTS.GRANULES.value}.json",
        parameters={"keyword": cleaned_keyword},
    )
    if response is not None:
        search_response: SearchResponse = SearchResponse(**response)
